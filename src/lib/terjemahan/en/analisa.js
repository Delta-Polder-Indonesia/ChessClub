...
export const analisa = {
    ...
    statistik: {
      ...
      kalah: "Loss",
      games: "Games",
      memuat: "Loading stats…",
      tarikData: "Fetching all games from chess.com…",
      belumAdaData: "No data for this account yet.",
      tarik: "Fetch account data",
      terakhir: "Last update",
      bukaTabel: "View game list",
      kembaliKeStatistik: "Back to stats",
      totalGame: "{total} games",
      tinggi: "Highest",
      rendah: "Lowest",
      akunTidakDitemukan: "No chess.com player with that name.",
      rentang: {
        "7d": "7 days",
        "30d": "30 days",
        "90d": "90 days",
    ...
    basisData: {
      ...
      cariKoleksi: "Search accounts / databases…",
      detail: "Game Details",
      tanggal: "Date",
      langkah: "Moves",
      pemain: "Players",
      ...
      mergePlayersDesc: "Replace all occurrences of the first player with the second player in the database.",
      player1: "Player 1",
      player2: "Player 2",
      merge: "Merge",
      ...
      removeEmpty: "Remove Empty Games",
      kembaliKeData: "Back to Data",
      belumAdaKoleksi: "No databases / accounts yet",
      konfirmasiHapusDuplikat: "Remove all duplicate games in this collection?",
      konfirmasiHapusKosong: "Remove all empty games in this collection?",
    },
    impor: {
      judul: "Import game",
      tipe: "Import type",
