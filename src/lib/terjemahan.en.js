...
export const EN = {
  ...
  papan: {
    ...
    tabAnalisa: "Analysis",
    tabBuku: "Books",
    tabPenjelajah: "Explorer",
    tabPartai: "Games",
    aksiBaru: "New",
    aksiSalinPgn: "Copy PGN",
    aksiMuat: "Load",
    aksiSalinFen: "Copy FEN",
    pemainPutih: "White",
    pemainHitam: "Black",
    lisensiAtribusi: "License & attribution",
    dialogJudul: "Enter PGN / FEN",
    dialogContoh: "1. e4 e5 2. Nf3 Nc6 3. Bb5 … (or paste a FEN)",
    dialogBatal: "Cancel",
    dialogGagal: "This PGN/FEN could not be loaded — please check the text.",
