...
import { BISHOP, KNIGHT, PAWN, QUEEN, ROOK, WHITE } from "chess.js";
...
function SimplePieceSVG({ piece, color, size, dataset, className, style, draggable, title }) {
