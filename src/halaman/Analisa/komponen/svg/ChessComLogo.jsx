export default function ChessComLogo({ className = "h-[30px] w-[30px]" }) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 379 105" xmlSpace="preserve" className={className} aria-hidden="true">
