...
function Clock(props) {
  ...
  return <div className={`flex text-nowrap justify-end vertical:pr-3 pr-[6px] vertical:text-2xl text-base font-bold items-center vertical:h-11 h-7 vertical:min-w-36 vertical:max-w-36 min-w-16 max-w-16 rounded-borderRoundness border border-slate-200 ${moving ? "" : "opacity-50"} ${white ? "bg-backgroundWhiteClock" : "bg-backgroundBlackClock"} ${white ? "text-backgroundBlackClock" : "text-backgroundWhiteClock"}`}>
            {time}
        </div>;
}
export {
