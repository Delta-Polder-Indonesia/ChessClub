        ...
        {SOCIAL_LINKS.length > 0 && (
          ...
          >
            {SOCIAL_LINKS.map((s) => (
              ...
              >
                {s.img ? (
                  // logo.svg tidak masuk manifest gambar karena berupa SVG.
                  // Tetapkan ukuran intrinsik 1000×304 agar rasio/aspect-ratio
                  // diketahui browser sebelum file selesai dimuat, sehingga
                  // Lighthouse/PageSpeed tidak menandai CLS pada elemen ini.
                  <img
...
function SocialIcon({ name }) {
  switch (name) {
    ...
    case "instagram":
      return (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M12 2.16c3.2 0 3.58.01 4.85.07 1.17.05 1.8.25 2.23.42.56.22.96.48 1.38.9.42.42.68.82.9 1.38.16.42.36 1.06.42 2.23.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.06 1.17-.26 1.8-.42 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.42.16-1.06.36-2.23.42-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.06-1.8-.26-2.23-.42a3.7 3.7 0 0 1-1.38-.9 3.7 3.7 0 0 1-.9-1.38c-.16-.42-.36-1.06-.42-2.23C2.17 15.58 2.16 15.2 2.16 12s.01-3.58.07-4.85c.06-1.17.25-1.8.42-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.42-.22 1.06-.36 2.23-.42C8.42 2.17 8.8 2.16 12 2.16zm0 3.68a6.16 6.16 0 1 0 0 12.32 6.16 6.16 0 0 0 0-12.32zm0 10.16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.4-10.4a1.44 1.44 0 1 0 0-2.88 1.44 1.44 0 0 0 0 2.88z" />
        </svg>
      );
    default:
      return null;
