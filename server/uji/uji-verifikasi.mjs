...
console.log("\nVerifikasi kode di profil (lewat HTTP)");
{
  ...
  if (!hidup) {
    console.log("  (server tidak berjalan — bagian ini dilewati)");
  } else {
    ...
    cek("username tak valid -> 400", takValid.status === 400);
    ...
    cek("periksa tanpa minta kode -> 400", belumMinta.status === 400);
